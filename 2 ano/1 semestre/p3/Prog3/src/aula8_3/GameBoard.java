...
public class GameBoard extends JFrame {
    ...
    private void win() {
        ...
        JOptionPane.showMessageDialog(this.getContentPane(), "Ganhou o pr�mio m�ximo de " + quest.getPrize() + "�.");
        endGame();
    }

    private void lose() {

        JOptionPane.showMessageDialog(this.getContentPane(), "Perdeu. Pr�mio de consola��o: " + questions.lastQuestionPrize() + "�.");
        endGame();
    }
