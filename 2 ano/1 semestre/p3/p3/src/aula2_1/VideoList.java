	...
	private ArrayList<Video> lista;
	  ...
	  public void delVideo(int in) {
		  ...
		  try {
			  ...
			  System.out.printf("Nenhum vídeo para remover.\n");
		  }
	  }
	  ...
	  public void video(int id) {
		  ...
		  try {
			...
			System.out.printf(tmp.toString());
			  ...
			  System.out.print("Vídeo não existente\n");
		  }
	  }
	  ...
	  public void videoDisponivel(int id) {
		  ...
		  try {
			  ...
			  tmp = lista.get(id-1);
			  if (tmp.isAvailable())
				  System.out.printf("Vídeo disponível.\n");
			  else
				  System.out.printf("Vídeo não disponível.\n");
		  }
		  catch(IndexOutOfBoundsException e) {
			  
			  System.out.println("Vídeo não existente.");
		  }
	  }
