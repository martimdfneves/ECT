  ...
  do
  {
    ...
    switch (Option)
    {
        ...
        case 5 :  ReadDigraphIndex (&Digraph1, "digrafo/grafo");
		          ...
		          ReadCostDist (&Cost, "Custo da aresta");
        ...
        case 12 : ReadDigraphIndex (&Digraph1, "digrafo");
                  ...
                  if (Error) { WriteErrorMessage (Error, "A classificacao de vertices"); break; }
		          printf("\e[1m\e[34;1f| Classificacao do vertice %d = %f ", Vertex1, Classification);
                  printf("\e[0m\e[35;1f| Prima uma tecla para continuar ");
                  scanf ("%*[^\n]"); scanf ("%*c");
                  break;
        ...
        case 13 : ReadDigraphIndex (&Digraph1, "digrafo");
                  ...
                  if (Error) { WriteErrorMessage (Error, "A fragmentacao de aresta"); break; }
                  break;
        ...
        case 14 : ReadDigraphIndex (&Digraph1, "digrafo");
                  ...
                  if (Error) { WriteErrorMessage (Error, "A substituicao do vertice"); break; }
                  break;

        case 15:  ReadDigraphIndex (&Digraph1, "digrafo origem");
                  if (NotActiveDigraph (DigraphArray, Digraph1)) break;
                  do
                  {
        ...
        case 17:  ReadDigraphIndex (&Digraph1, "digrafo");
                  if (NotActiveDigraph (DigraphArray, Digraph1)) break;
                  ReadVertex (&Vertex1);
                  ReadCostDist (&Dist, "Distancia      ");
                  Error = AllSuccDist (DigraphArray[Digraph1], Vertex1, Dist, &Queue);
                  if (Error) { WriteErrorMessage (Error, "Os vertices sucessores"); break; }
                  if (QueueIsEmpty (Queue)) printf("\e[1m\e[34;1f| Nao existem vertices sucessores do vertice %d a distancia menor do que %d", Vertex1, Dist);
                  else PrintQueue (Queue, "Sucessor(es) -> ");
				  QueueDestroy (&Queue);
                  printf("\e[0m\e[35;1f| Prima uma tecla para continuar ");
                  scanf ("%*[^\n]"); scanf ("%*c");
                  break;
        ...
        case 18 : ReadDigraphIndex (&Digraph1, "digrafo");
                  ...
                  if (Error) { WriteErrorMessage (Error, "A determinacao de arestas incidentes"); break; }
                  if (QueueIsEmpty (Queue)) printf("\e[1m\e[34;1f| Nao existem arestas incidentes no vertice %d", Vertex1);
		          else PrintQueuePair (Queue, "Aresta(s) incidente(s)");
				  QueueDestroy (&Queue);
				  printf("\e[0m\e[35;1f| Prima uma tecla para continuar ");
                  scanf ("%*[^\n]"); scanf ("%*c");
                  break;
...
void Menu (void)
{
  ...
  printf("\e[16;1f| 12 - Classificacao do vertice  | Digrafo 11 =                 |                                                          |\n");
  printf("\e[17;1f| 13 - Subdividir Aresta         | Digrafo 12 =                 |                                                          |\n");
  printf("\e[18;1f| 14 - Cindir vertice            | Digrafo 13 =                 |                                                          |\n");
  printf("\e[19;1f| 15 - Digrafo transposto        | Digrafo 14 =                 |                                                          |\n");
  printf("\e[20;1f| 16 - Digrafo complementar      | Digrafo 15 =                 |                                                          |\n");
  printf("\e[21;1f| 17 - Vertices sucessores       | Digrafo 16 =                 |                                                          |\n");
  printf("\e[22;1f| 18 - Arestas incidentes        | Digrafo 17 =                 |                                                          |\n");
  printf("\e[23;1f| 19 - xxxxxxxxxxxxxxxxxx        | Digrafo 18 =                 |                                                          |\n");
