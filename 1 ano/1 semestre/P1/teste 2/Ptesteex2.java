...
public class Ptesteex2 {
    ...
    public static boolean mat(String m) {
        ...
        if (Character.isLetter(m.charAt(0)) && Character.isLetter(m.charAt(1)) && Character.isDigit(m.charAt(3)) && Character.isDigit(m.charAt(4)) && Character.isDigit(m.charAt(6)) && Character.isDigit(m.charAt(7)))
            return true;
        if (Character.isDigit(m.charAt(0)) && Character.isDigit(m.charAt(1)) && Character.isLetter(m.charAt(3)) && Character.isLetter(m.charAt(4)) && Character.isDigit(m.charAt(6)) && Character.isDigit(m.charAt(7)))
            return true;
        if (Character.isDigit(m.charAt(0)) && Character.isDigit(m.charAt(1)) && Character.isDigit(m.charAt(3)) && Character.isDigit(m.charAt(4)) && Character.isLetter(m.charAt(6)) && Character.isLetter(m.charAt(7)))
            return true;
