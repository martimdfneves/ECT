...
--
-- A simple example of the use of the clock_generator entity can be found in the file clock_generator_example_tl.vhd
--
...
entity clock_generator is
  generic
  (
    NEW_CLOCK_FREQUENCY : real range 1.0e6 to 250.0e6 -- (in Hz) desired frequency
  );
  port
  (
...
begin
  ...
  PLL : altpll
    ...
    (
      ...
      clk0_duty_cycle         => 50,
      clk0_multiply_by        => integer(NEW_CLOCK_FREQUENCY),
      clk0_phase_shift        => "0",
