...
-- Equation(s):
-- \inst|decOut_n[6]~0_combout\ = (\SW[1]~input_o\ & (!\SW[3]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\))) # (!\SW[1]~input_o\ & (\SW[3]~input_o\ $ (((!\SW[2]~input_o\)))))
...
-- Equation(s):
-- \inst|decOut_n[5]~1_combout\ = (!\SW[3]~input_o\ & ((\SW[0]~input_o\ & ((\SW[1]~input_o\) # (!\SW[2]~input_o\))) # (!\SW[0]~input_o\ & (\SW[1]~input_o\ & !\SW[2]~input_o\))))
...
-- Equation(s):
-- \inst|decOut_n[4]~2_combout\ = (\SW[0]~input_o\ & ((\SW[2]~input_o\ & (!\SW[3]~input_o\)) # (!\SW[2]~input_o\ & ((!\SW[1]~input_o\))))) # (!\SW[0]~input_o\ & (!\SW[3]~input_o\ & (\SW[1]~input_o\ $ (\SW[2]~input_o\))))
...
-- Equation(s):
-- \inst|decOut_n[2]~4_combout\ = (\SW[0]~input_o\ & (\SW[1]~input_o\ & (\SW[3]~input_o\ $ (!\SW[2]~input_o\)))) # (!\SW[0]~input_o\ & (\SW[3]~input_o\ & ((\SW[2]~input_o\))))
