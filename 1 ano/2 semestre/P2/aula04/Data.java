...
public class Data {
    ...
    public Data(String data) {
        ...
        assert dt[0] != "" : "ano ao valido";
        assert dt[1] != "" : "mesnao valido";
        assert dt[2] != "" : "dia nao valido";

        if (dt[0] == "" || dt[1] == "" || dt[2] == "") {
            System.out.println("Data inválida");
            System.exit(1);
        } else {
            dia = Integer.parseInt(dt[2]);
            mes = Integer.parseInt(dt[1]);
            ano = Integer.parseInt(dt[0]);
        }
    }
    ...
    public static int diasDoMes(int Mes, int Ano) {
        ...
        assert (Mes > 1 || Mes < 12) : "mes nao valido";
        assert Ano > 1 : "ano nao valido";
