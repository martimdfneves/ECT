...
public class TestData3 {
  ...
  public static void main(String[] args) {
    ...
    // check it:
    assert (d.val_dia()==29 && d.val_mes()==2 && d.val_ano()==2000):"";
    ...
    out.println(d);
    assert d.val_dia() == today.val_dia();
    assert d.val_mes() == today.val_mes();
    assert d.val_ano() == today.val_ano()+400;  // exactly 400 years from now!
