...
HD_PWD='C:/Users/marti/Desktop/Uni/5 ano/2 semestre/CR/guiao 2/exe2/exe2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrapper_4.tcl -notrace
