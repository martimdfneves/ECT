...
HD_PWD='C:/Users/marti/Desktop/Uni/5 ano/2 semestre/CR/guiao 2/exe2/exe2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapper_4.tcl
