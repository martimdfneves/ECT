...
HD_PWD='C:/Users/marti/Desktop/Uni/5 ano/2 semestre/CR/guiao 3/exe3/exe3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrapper_2.tcl -notrace
