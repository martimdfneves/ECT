    ...
    /**
	   ...
	   */
	   ...
	   public static void main(String[] args)
	   {
	    ...
	    GenericIO.writelnString ("\033[42m General Repository object was registered!  \033[0m");
	    
	    /* wait for the end of operations */

	    GenericIO.writelnString ("\033[42m General Repository is in operation!  \033[0m");
	    try
	    { while (!end)
	    ...
	    GenericIO.writelnString ("\033[41m General Repository was deregistered! \033[0m");
	    ...
	    if (shutdownDone)
	       GenericIO.writelnString ("\033[41m General Repository was shutdown!  \033[0m");
	}
