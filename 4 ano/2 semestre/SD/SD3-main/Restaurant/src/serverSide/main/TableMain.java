	 ...
	 /**
	   ...
	   */
	   ...
	   public static void main (String[] args)
	   {
	    ...
	    GenericIO.writelnString ("\033[42m Table object was registered! \033[0m");
	    
	    /* wait for the end of operations */

	    GenericIO.writelnString ("\033[42m Table is in operation! \033[0m");
	    try
	    { while (!end)
	        ...
	        { try
	          ...
	          { GenericIO.writelnString ("TableMain main thread was interrupted!");
	          }
	        }
	    }
	    ...
	    GenericIO.writelnString ("\033[41m Table was deregistered! \033[0m");
	    ...
	    if (shutdownDone)
	       GenericIO.writelnString ("\033[41m Table was shutdown! \033[0m");
	   }   
