...
public class ServerCom{
	 ...
	 * @throws SocketTimeoutException occurs when has not received a new Message during the timeout time.
	 */
	...
	/**
	 * Set the Timeout Attribute on the communication socket.
	 *
	 * @param timeout milliseconds for the timeout configuration 
	 */
