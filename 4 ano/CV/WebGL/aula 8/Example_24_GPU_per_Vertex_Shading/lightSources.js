...
// Light source 2 VERDE

lightSources.push( new LightSource() );

lightSources[2].setPosition( 0.0, 0.0, 10.0, 1.0 );

lightSources[2].setIntensity( 0.0, 1.0, 0.0 );

lightSources[2].setAmbIntensity( 0.2, 0.2, 0.2 );

// Light source 3 BRANCA

lightSources.push( new LightSource() );

lightSources[3].setPosition( 0.0, -10.0, 0.0, 1.0 );
...
//lightSources[3].setRotationSpeed( 0.5 );
