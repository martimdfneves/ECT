function [PLdata, APDdata, MPDdata, TT, PLvoip, APDvoip, MPDvoip] = Simulator4c(lambda,C,f,P,n)
% INPUT PARAMETERS:
            ...
            elseif type == 1 % VoIP packet
                ...
                if STATE==0
                    ...
                    if QUEUEOCCUPATION + PacketSize <= f
                        ...
                        %Sort Queue by type (Data or VoIP)
                        % VoIP vão ter prioridade sobre os de data
