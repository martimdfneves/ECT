...
-- *****************************************************************************
-- Generated on "12/15/2020 17:15:48"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          CRC_Checker_STD
-- 
...
ENTITY CRC_Checker_STD_vhd_vec_tst IS
END CRC_Checker_STD_vhd_vec_tst;
ARCHITECTURE CRC_Checker_STD_arch OF CRC_Checker_STD_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL Check : STD_LOGIC;
SIGNAL CRC_err : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL dIN : STD_LOGIC_VECTOR(23 DOWNTO 0);
COMPONENT CRC_Checker_STD
	PORT (
	Check : OUT STD_LOGIC;
