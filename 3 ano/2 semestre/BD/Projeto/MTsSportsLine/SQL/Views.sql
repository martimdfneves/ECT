...
FROM ((Projeto.Loja JOIN Projeto.Artigo_Loja ON Loja.NumLoja = Artigo_Loja.NumLoja)
         JOIN Projeto.Artigo ON Artigo_Loja.Codigo = Artigo.Codigo) GO
-----------------------------------------------------------------
GO
...
FROM ((Projeto.Armazem JOIN Projeto.Artigo_Armazem ON Armazem.IDArmazem = Artigo_Armazem.IDArmazem)
         JOIN Projeto.Artigo ON Artigo_Armazem.Codigo = Artigo.Codigo) GO
-----------------------------------------------------------------
GO
...
FROM (Projeto.Loja JOIN Projeto.Funcionario ON Loja.NumLoja = Funcionario.NumLoja) GO
-----------------------------------------------------------------
GO
