...
(
    ...
    Categoria VARCHAR(20) NOT NULL,            -- Vestu�rio, Cal�ado e Acess�rios
    PRIMARY KEY (Codigo)
);
...
VALUES (156428, 69.99, 'Camisola Equipamento SLB', 'Vestu�rio'),
       (245875, 59.99, 'Camisola Equipamento SCP', 'Vestu�rio'),
       (114526, 19.99, 'Pulseira Desportiva', 'Acess�rios'),
       (177895, 9.99, 'Tapete gin�stica/yoga', 'Acess�rios'),
       (103568, 1.99, 'Touca nata��o', 'Acess�rios'),
       (165856, 89.99, 'Raquete T�nis Head Ig Challenge Pro', 'Acess�rios'),
       (187853, 9.99, 'Bolas T�nis Dunlop Bipk4', 'Acess�rios'),
       (130055, 19.99, 'Cal��es Puma', 'Vestu�rio'),
       (172733, 59.99, 'Camisola Equipamento FCP', 'Vestu�rio'),
       (291208, 29.99, 'Rel�gio Silver Portugal', 'Acess�rio'),
       (827127, 14.99, 'Bon� Adidas a3', 'Acess�rio'),
       (758763, 15.49, 'Casaco de Ciclismo', 'Vestu�rio'),
       (172630, 4.99, 'Gorro Star Wars', 'Acess�rios'),
       (198932, 189.99, 'Halteres 20 Kg Bodytone', 'Acess�rios'),
       (231230, 3.99, 'Meias Invis�veis', '�Vestu�rio'),
       (231310, 7.99, 'Meias Curtas Adidas', 'Vestu�rio'),
       (198359, 41.24, 'Camisola T�rmica Nike', 'Vestu�rio'),
       (187651, 49.99, 'Casaco Adidas Foil', 'Vestu�rio'),
       (190826, 39.99, 'Corta-vento Nike', 'Vestu�rio'),
       (168194, 12.99, 'Luvas Boxe', 'Acess�rios'),
       (892339, 14.99, 'Cal��es Silver Re-mimetic', 'Vestu�rio'),
       (128626, 41.24, 'Botas Converse Rival', 'Cal�ado'),
       (101561, 39.99, 'Smartwatch Innova', 'Acess�rios'),
       (178978, 12.99, '�culos Nata��o', 'Acess�rios'),
       (825488, 39.19, 'Sapatilha Adidas Runfalcon', 'Cal�ado'),
       (148597, 14.99, 'Bola futebol Adidas final 19', 'Acess�rios'),
       (154004, 14.99, 'Bola basquetebol Nike baller', 'Acess�rios'),
       (187634, 29.99, 'Sapatilha Puma Up Cl�ssico', 'Cal�ado'),
       (636548, 9.49, 'Mochila Puma Phase', 'Acess�rios'),
       (204860, 179.99, 'Prancha de surf Quiksilver', 'Acess�rios'),
       (176530, 9.99, 'Luvas Ciclismo Mitical', 'Acess�rios'),
       (821728, 25.99, 'Bon� North Face', 'Acess�rio'),
       (826096, 29.99, 'Cal�as Montanha', 'Vestu�rio'),
       (176537, 69.99, 'Sapatilha Air Max', 'Cal�ado'),
       (190005, 49.99, 'Sapatilha Nike MD Runner 2', 'Cal�ado'),
       (402456, 49.99, 'Chuteiras Nike Mercurial', 'Cal�ado'),
       (578954, 19.99, 'Bola Euro 2020', 'Acess�rios'),
       (253619, 29.74, 'Cal�as Nike Academy', 'Vestu�rio'),
       (827412, 35.99, 'Cal�as Adidas Aop', 'Vestu�rio'),
       (958944, 42.39, 'Sapatilha Nike Zoom', 'Cal�ado'),
       (198208, 79.99, 'Casaco Puma Metal Mulher', 'Vestu�rio'),
       (442211, 11.99, 'Casaco Montanha Boriken', 'Vestu�rio'),
       (290212, 6.49, 'Casaco Polar Up', 'Vestu�rio'),
       (908123, 10.49, 'Casaco Acolchoado Boriken', 'Vestu�rio'),
       (231631, 12.99, 'Bon� Adidas Logo Metal', 'Acess�rio'),
       (921733, 24.99, 'Puls�metro Army Watch', 'Acess�rio')
    INSERT
INTO Projeto.Artigo_Armazem(Codigo, IDArmazem, QuantArtigos)
...
VALUES (402456, 130254, 1),
       ...
       (198208, 174896, 1)
    INSERT
INTO Projeto.Transporte(IDTransporte, Data, Destino)
...
-- LOJA 3
       ...
       (130055, 3, 19)
    INSERT
INTO Projeto.Loja(NumLoja, Nome, Localizacao)
...
VALUES (758763, 30023, 2),
       ...
       (198208, 30028, 1)
    INSERT
INTO Projeto.Devolucao(IDDevolucao, Data, Montante, NIF, NumFunc)
...
VALUES (578954, 30000, 2),
       ...
       (156428, 34252, 2)
    INSERT
INTO Projeto.Compra(NumCompra, Data, Montante, NIF, NumFunc)
