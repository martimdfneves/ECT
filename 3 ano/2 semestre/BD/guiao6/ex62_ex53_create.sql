...
SELECT *
FROM ex53a.Medico; -- TEM VALORES
SELECT *
FROM ex53a.Paciente; -- TEM VALORES
SELECT *
FROM ex53a.Farmacia; -- TEM VALORES
SELECT *
FROM ex53a.Farmaceutica; -- TEM VALORES
SELECT *
FROM ex53a.Farmaco; -- TEM VALORES
SELECT *
FROM ex53a.Prescricao; -- TEM VALORES
SELECT *
FROM ex53a.Venda; -- TEM VALORES