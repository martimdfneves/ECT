...
DROP
CONSTRAINT CNTDENCOMENDA;
ALTER TABLE ex52.Encomenda
DROP
CONSTRAINT NIFENCOMENDA;
...
VALUES (10001, 'Bife da Pa', 8.75, 23, 125),
    ...
    INSERT
INTO ex52.Conteudo(ENCOMENDA, PRODUTO, UNIDADES)
VALUES (1, 10001, 200),
    (1, 10004, 300),
    (2, 10002, 1200),
    (2, 10003, 3200),
...
SELECT *
FROM ex52.Conteudo; -- TEM VALORES
SELECT *
FROM ex52.Encomenda; -- TEM VALORES
SELECT *
FROM ex52.Fornecedor; -- TEM VALORES
SELECT *
FROM ex52.Produto; -- TEM VALORES
SELECT *
FROM ex52.Tipo_Fornecedor; -- TEM VALORES